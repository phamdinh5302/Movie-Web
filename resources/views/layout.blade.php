...
<head>
    ...
    <link rel="shortcut icon"
        href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmDSoXv8slT95vYmx7GDcvzDjYrG8jxfkSKg&usqp=CAU"
        type="image/x-icon" />
...
<body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="row" id="headwrap">
                <div class="col-md-3 col-sm-6 slogan">
                    <a class="logo" href="{{ route('homepage') }}" title="phim hay ">
                        <img style="width=40%" src="https://phimmoiyyy.net/wp-content/uploads/2023/03/phimmoi.png"
                            alt="logo">
                    </a>
                </div>
                            ...
                            <div class="form-group form-timkiem">
                                <div class="input-group col-xs-12" >
                                    <form action="{{route('tim-kiem')}}" method="GET" style="display: flex">
                                        ...
                                        <i class="animate-spin hl-spin4 hidden"></i>
                                        <button class="btn btn-primary"  style="margin-left: 10px">Tìm kiếm</button>
                                    </form>
                                </div>
                            </div>
                            <ul  class="list-group " id="result"  style="display: none;
                ...
                <div class="widget about col-xs-12 col-sm-4 col-md-4">
                    <div class="footer-logo">
                        <img class="img-responsive"
                            src="https://phimmoinet.online/wp-content/themes/haunmovies/assets/images/phimmoi-net-online.png"
                            alt="Phim hay 2023- Xem phim hay nhất" />
                    </div>
    ...
    {{-- script comment fb --}}
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v17.0" nonce="CkLV01DH">
    </script>
                    ...
                    $.getJSON('/json/movie.json', function(data){
                        $.each(data, function(key,value){
                            if(value.title.search(expression) != -1 || value.name_eng.search(expression) != -1 ){
                                ...
                                $('#result').append('<a href="/phim/'+value.slug+'"><li style="cursor:pointer; display: flex; align-items: center; " class="list-group-item"><img src="/uploads/movie/'+value.image+'" width="40" height="40" class="" /><div style="display: flex; flex: 1; flex-direction: column;"><h4 style="margin-left: 6px; font-size: 1.5rem; color:#fff;flex: 1;" width="100%" ">'+value.title+'.</h4>  <h4 style="font-size: 1.3rem; margin-left: 6px; color:#ccc; flex: 1;"> '+value.name_eng+'</h4></div></li></a>');
                            }
                            });
                        });
                }else{
    ...
    <style>
        ...
        * html .float-ck
        ...
        /* IE6 position fixed Bottom
         {position:absolute;bottom:auto;top:expression(eval (document.documentElement.scrollTop+document.docum entElement.clientHeight-this.offsetHeight-(parseInt(this.currentStyle.marginTop,10)||0)-(parseInt(this.currentStyle.marginBottom,10)||0))) ;}*/
        #hide_float_left a {
            background: #0098D2;
